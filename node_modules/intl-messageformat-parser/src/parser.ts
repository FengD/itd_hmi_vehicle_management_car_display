...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c55 = peg$otherExpectation("whitespace pattern");
  const peg$c56 = /^[\t-\r \x85\u200E\u200F\u2028\u2029]/;
  const peg$c57 = peg$classExpectation([["\t", "\r"], " ", "\x85", "\u200E", "\u200F", "\u2028", "\u2029"], false, false);
  const peg$c58 = peg$otherExpectation("syntax pattern");
  const peg$c59 = /^[!-\/:-@[-\^`{-~\xA1-\xA7\xA9\xAB\xAC\xAE\xB0\xB1\xB6\xBB\xBF\xD7\xF7\u2010-\u2027\u2030-\u203E\u2041-\u2053\u2055-\u205E\u2190-\u245F\u2500-\u2775\u2794-\u2BFF\u2E00-\u2E7F\u3001-\u3003\u3008-\u3020\u3030\uFD3E\uFD3F\uFE45\uFE46]/;
  const peg$c60 = peg$classExpectation([["!", "/"], [":", "@"], ["[", "^"], "`", ["{", "~"], ["\xA1", "\xA7"], "\xA9", "\xAB", "\xAC", "\xAE", "\xB0", "\xB1", "\xB6", "\xBB", "\xBF", "\xD7", "\xF7", ["\u2010", "\u2027"], ["\u2030", "\u203E"], ["\u2041", "\u2053"], ["\u2055", "\u205E"], ["\u2190", "\u245F"], ["\u2500", "\u2775"], ["\u2794", "\u2BFF"], ["\u2E00", "\u2E7F"], ["\u3001", "\u3003"], ["\u3008", "\u3020"], "\u3030", "\uFD3E", "\uFD3F", "\uFE45", "\uFE46"], false, false);
  const peg$c61 = peg$otherExpectation("optional whitespace");
  const peg$c62 = peg$otherExpectation("number");
  const peg$c63 = "-";
  const peg$c64 = peg$literalExpectation("-", false);
  const peg$c65 = function(negative: any, num: any): any {
      return num 
          ? negative 
              ? -num 
              : num 
  ...
  const peg$c66 = peg$otherExpectation("apostrophe");
  const peg$c67 = peg$otherExpectation("double apostrophes");
  const peg$c68 = "''";
  ...
  const peg$c73 = function(escapedChar: any, quotedChars: any): any {
      return escapedChar + quotedChars.replace(`''`, `'`);
  };
  const peg$c74 = /^[^{}]/;
  const peg$c75 = peg$classExpectation(["{", "}"], true, false);
  const peg$c76 = peg$otherExpectation("argNameOrNumber");
  const peg$c77 = peg$otherExpectation("argNumber");
  const peg$c78 = "0";
  const peg$c79 = peg$literalExpectation("0", false);
  const peg$c80 = function(): any { return 0 };
  const peg$c81 = /^[1-9]/;
  const peg$c82 = peg$classExpectation([["1", "9"]], false, false);
  const peg$c83 = /^[0-9]/;
  const peg$c84 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c85 = function(digits: any): any {
          return parseInt(digits.join(''), 10);
      };
  const peg$c86 = peg$otherExpectation("argName");
