...
@color-brand1-6: #3080FE;

@color-brand1-9: #1861D5;
...
@color-success-1: #D6FFF3;

@color-success-2: #75EBC7;

@color-success-3: #2ECA9C;

@color-success-4: #009468;

@color-notice-1: #EAF0FF;

@color-notice-2: #A3BEFF;

@color-notice-3: #5485F7;

@color-notice-4: #244FB3;
...
@icon-font-path: "//at.alicdn.com/t/font_997286_q8pck7x35wb";
...
@checkbox-hovered-border-color: #3080FE;
...
@checkbox-disabled-circle-color: #E0E0E0;

@checkbox-checked-hovered-circle-color: #FFFFFF;

@checkbox-bg-color: #FFFFFF;

@checkbox-checked-bg-color: #3080FE;

@checkbox-hovered-bg-color: #E2EDFF;

@checkbox-checked-hovered-bg-color: #1861D5;
...
@timeline-item-process-background: #3080FE;

@timeline-item-process-color: #FFFFFF;

@timeline-item-success-dot-size: 8px;

@timeline-item-success-background: #2ECA9C;
...
@tree-node-selected-background: #E2EDFF;

@tree-node-disabled-color: #E0E0E0;
...
@menu-btn-disabled-icon-color: #E0E0E0;
...
@menu-btn-pure-text-secondary-icon-color: #3080FE;
...
@range-size-m-mark-font-size: 14px;
...
@range-normal-selected-color: #3080FE;
...
@range-normal-selected-color-hover: #3080FE;
...
@range-normal-mark-color-disabled: #E0E0E0;
...
@search-normal-primary-color: #3080FE;

@search-normal-primary-hover-color: #3080FE;
...
@search-normal-primary-btn-hover-bg-color: #1861D5;
...
@search-normal-primary-l-height: 40px;

@search-normal-primary-l-icon-size: 24px;

@search-normal-primary-l-btn-text-size: 16px;

@search-normal-primary-m-height: 32px;

@search-normal-primary-m-icon-size: 12px;
...
@search-normal-secondary-hover-color: #3080FE;

@search-normal-secondary-shadow: none;

@search-normal-secondary-btn-bg-color: #3080FE;

@search-normal-secondary-btn-text-color: #FFFFFF;

@search-normal-secondary-btn-hover-bg-color: #1861D5;
...
@search-normal-secondary-l-height: 40px;

@search-normal-secondary-l-icon-size: 24px;

@search-normal-secondary-l-btn-text-size: 16px;

@search-normal-secondary-m-height: 32px;

@search-normal-secondary-m-icon-size: 12px;
...
@search-normal-dark-btn-hover-bg-color: #1861D5;
...
@rating-normal-overlay-color: #3080FE;

@rating-normal-overlay-hover-color: #3080FE;

@rating-grade-low-overlay-color: #666666;

@rating-grade-low-overlay-hover-color: #999999;

@rating-grade-high-overlay-color: #3080FE;

@rating-grade-high-overlay-hover-color: #3080FE;
...
@card-title-bullet-color: #3080FE;
...
@switch-normal-on-bg-color: #3080FE;

@switch-hover-on-bg-color: #1861D5;
...
@switch-disabled-on-color-font: #E0E0E0;
...
@tag-secondary-text-color: #3080FE;

@tag-normal-text-color-hover: #3080FE;
...
@tag-bordered-tail-color-disabled: #E0E0E0;

@tag-bordered-text-color-disabled: #E0E0E0;

@tag-bordered-border-color-disabled: #E6E7EB;

@tag-bordered-bg-disabled: #F7F8FA;

@tag-secondary-text-color-hover: #1861D5;

@tag-bordered-border-color: #C4C6CF;

@tag-secondary-border-color: #3080FE;

@tag-checkable-normal-bg-selected: #3080FE;

@tag-checkable-secondary-bg-selected: #3080FE;

@tag-bordered-border-color-hover: #A0A2AD;

@tag-secondary-border-color-hover: #1861D5;

@tag-checkable-normal-bg-selected-hover: #1861D5;

@tag-checkable-secondary-bg-selected-hover: #1861D5;

@tag-fill-bg-color: #EBECF0;

@tag-primary-background-color: #3080FE;
...
@tag-checkable-fill-tail-color-disabled: #E0E0E0;

@tag-checkable-fill-text-color-disabled: #E0E0E0;
...
@tag-checkable-normal-text-selected-disabled: #E0E0E0;
...
@tag-checkable-primary-bg-color: #3080FE;

@tag-checkable-primary-text-color-hover: #FFFFFF;

@tag-checkable-primary-bg-color-hover: #1861D5;
...
@tag-primary-bg-color-disabled: #E2EDFF;
...
@input-focus-border-color: #3080FE;
...
@input-feedback-success-color: #2ECA9C;

@input-feedback-loading-color: #5485F7;

@input-feedback-error-border-color: #FF3000;

@input-maxlen-error-color: #FF3000;
...
@table-sort-color-current: #3080FE;
...
@btn-pure-color-disabled: #E0E0E0;
...
@btn-pure-secondary-color: #3080FE;

@btn-pure-secondary-color-hover: #FFFFFF;

@btn-pure-secondary-bg: #FFFFFF;

@btn-pure-secondary-bg-hover: #1861D5;

@btn-pure-secondary-border-color: #3080FE;

@btn-pure-secondary-border-color-hover: #1861D5;
...
@btn-pure-primary-bg: #3080FE;

@btn-pure-primary-bg-hover: #1861D5;
...
@btn-warning-primary-color-disabled: #E0E0E0;
...
@btn-warning-normal-color-disabled: #E0E0E0;
...
@btn-text-primary-color-hover: #1861D5;

@btn-text-disabled-color: #E0E0E0;

@btn-text-loading-color: #333333;

@btn-text-secondary-color: #666666;

@btn-text-secondary-color-hover: #3080FE;

@btn-text-normal-color: #333333;

@btn-text-normal-color-hover: #3080FE;
...
@upload-disable-text-color: #E0E0E0;

@upload-disable-border-color: #E6E7EB;

@upload-text-list-height: 40px;

@upload-text-list-padding-left-right: 8px;

@upload-text-list-font-size: 14px;
...
@upload-text-list-error-text-color: #FF3000;
...
@upload-text-list-name-font-color-hover: #3080FE;

@upload-text-list-size-font-color: #999999;

@upload-text-list-size-font-color-hover: #3080FE;
...
@upload-image-list-item-picture-border-width: 1px;

@upload-image-list-item-thumbnail-font-color: #E0E0E0;

@upload-image-list-item-font-size: 14px;
...
@upload-image-list-item-uploading-bg-color: #FFFFFF;

@upload-image-list-item-error-bg-color: #FFFFFF;
...
@upload-image-list-item-border-color-error: #FF3000;

@upload-image-list-item-border-color-hover: #3080FE;
...
@upload-card-add-text-size: 14px;
...
@upload-card-hover-border-color: #3080FE;

@upload-card-font-color: #666666;

@upload-card-icon-color: #C4C6CF;

@upload-card-hover-font-color: #3080FE;
...
@upload-card-list-border-color-error: #FF3000;

@upload-card-list-thumbnail-font-color: #E0E0E0;
...
@upload-drag-zone-over-border-color: #3080FE;
...
@menu-icon-selected-color: #3080FE;
...
@menu-icon-selected-hover-color: #3080FE;

@menu-color-disabled: #E0E0E0;
...
@balloon-primary-color-bg: #E2EDFF;

@balloon-primary-color-border: #3080FE;
...
@balloon-tooltip-color-bg: #333333;

@balloon-tooltip-color-border: transparent;

@balloon-tooltip-border-style: solid;

@balloon-tooltip-color: #F7F8FA;
...
@message-size-l-content-font: 14px;
...
@message-success-color-bg-inline: #D6FFF3;

@message-success-color-bg-addon: transparent;

@message-success-color-bg-toast: #FFFFFF;

@message-success-color-border-inline: #D6FFF3;
...
@message-success-color-icon-inline: #2ECA9C;

@message-success-color-icon-addon: #2ECA9C;

@message-success-color-icon-toast: #2ECA9C;
...
@message-error-color-icon-inline: #FF3000;

@message-error-color-icon-addon: #FF3000;

@message-error-color-icon-toast: #FF3000;

@message-warning-color-bg-inline: #FFF9E0;

@message-warning-color-bg-addon: transparent;

@message-warning-color-bg-toast: #FFFFFF;

@message-warning-color-border-inline: #FFF9E0;
...
@message-warning-color-icon-inline: #F1C826;

@message-warning-color-icon-addon: #F1C826;

@message-warning-color-icon-toast: #F1C826;

@message-notice-color-bg-inline: #EAF0FF;

@message-notice-color-bg-addon: transparent;

@message-notice-color-bg-toast: #FFFFFF;

@message-notice-color-border-inline: #EAF0FF;
...
@message-notice-color-icon-inline: #5485F7;

@message-notice-color-icon-addon: #5485F7;

@message-notice-color-icon-toast: #5485F7;

@message-help-color-bg-inline: #FFF9E0;

@message-help-color-bg-addon: transparent;

@message-help-color-bg-toast: #FFFFFF;

@message-help-color-border-inline: #FFF9E0;
...
@message-help-color-icon-inline: #F1C826;

@message-help-color-icon-addon: #F1C826;

@message-help-color-icon-toast: #F1C826;
...
@message-loading-color-icon-inline: #3080FE;

@message-loading-color-icon-addon: #3080FE;

@message-loading-color-icon-toast: #3080FE;
...
@badge-color-bg: #FF3000;

@badge-size-count-border-radius: 8px;

@badge-dot-color-bg: #FF3000;
...
@progress-line-normal-color: #3080FE;

@progress-line-error-color: #FF3000;

@progress-line-success-color: #2ECA9C;

@progress-line-started-color: #FF3000;

@progress-line-middle-color: #F1C826;

@progress-line-finishing-color: #2ECA9C;
...
@progress-circle-normal-color: #3080FE;

@progress-circle-error-color: #FF3000;

@progress-circle-success-color: #2ECA9C;

@progress-circle-started-color: #FF3000;

@progress-circle-middle-color: #F1C826;

@progress-circle-finishing-color: #2ECA9C;
...
@select-highlight-color: #3080FE;

@select-highlight-font: 14px;
...
@pagination-jump-font-size: 14px;
...
@pagination-current-color: #3080FE;
...
@pagination-size-selector-filter-current-color: #3080FE;

@pagination-item-current-color: #FFFFFF;

@pagination-arrow-hover-color: #333333;

@pagination-arrow-hover-color-noboder: #3080FE;

@pagination-arrow-color: #666666;

@pagination-item-current-border-color: #3080FE;

@pagination-item-current-bg: #3080FE;

@pagination-item-current-hover-color: #FFFFFF;

@pagination-item-current-hover-border-color: #3080FE;

@pagination-item-current-hover-bg: #3080FE;
...
@transfer-simple-panel-footer-text-color: #3080FE;

@transfer-simple-panel-item-hover-text-color: #3080FE;
...
@collapse-title-font-disabled-color: #E0E0E0;
...
@time-picker-menu-item-color-disabled: #E0E0E0;
...
@slick-dots-background-color-selected: #3080FE;
...
@slick-arrow-icon-color-disabled: #E0E0E0;

@slick-arrow-icon-color-disabled-outer: #E0E0E0;
...
@radio-hovered-bg-color: #E2EDFF;

@radio-checked-bg-color: #3080FE;

@radio-disabled-bg-color: #F7F8FA;

@radio-checked-hovered-bg-color: #1861D5;

@radio-border-color: #C4C6CF;

@radio-hovered-border-color: #3080FE;

@radio-checked-border-color: #3080FE;
...
@radio-disabled-circle-color: #E0E0E0;

@radio-checked-hovered-circle-color: #FFFFFF;

@radio-normal-font-color: #333333;

@radio-normal-font-color-disabled: #E0E0E0;
...
@radio-button-border-color-checked: #3080FE;
...
@radio-button-font-color-checked: #3080FE;

@radio-button-font-color-disabled: #E0E0E0;

@radio-button-font-color-checked-disabled: #E0E0E0;
...
@step-arrow-item-process-background: #3080FE;

@step-arrow-item-title-process-color: #FFFFFF;

@step-arrow-item-finish-background: #E2EDFF;

@step-arrow-item-title-finish-color: #3080FE;

@step-arrow-item-disabled-background: #F7F8FA;

@step-arrow-item-title-disabled-color: #E0E0E0;
...
@step-circle-item-tail-finish-color: #3080FE;
...
@step-circle-item-title-disabled-color: #E0E0E0;
...
@step-circle-item-node-process-border-color: #3080FE;

@step-circle-item-node-process-background: #3080FE;

@step-circle-item-node-process-color: #FFFFFF;

@step-circle-item-node-process-percent-color: #3080FE;

@step-circle-item-node-finish-border-color: #3080FE;

@step-circle-item-node-finish-background: #FFFFFF;

@step-circle-item-node-finish-color: #3080FE;

@step-circle-item-node-disabled-border-color: #E6E7EB;

@step-circle-item-node-disabled-background: #FFFFFF;

@step-circle-item-node-disabled-color: #E0E0E0;
...
@step-dot-item-tail-finish-color: #3080FE;
...
@step-dot-item-title-disabled-color: #E0E0E0;
...
@step-dot-item-node-process-border-color: #3080FE;

@step-dot-item-node-process-background: #3080FE;

@step-dot-item-node-process-color: #3080FE;

@step-dot-item-node-finish-border-color: #3080FE;

@step-dot-item-node-finish-background: #FFFFFF;

@step-dot-item-node-finish-color: #3080FE;
...
@nav-secondary-sub-nav-bg-color: #3080FE;
...
@nav-secondary-item-hover-bg-color: #1861D5;

@nav-secondary-item-hover-text-color: #FFFFFF;

@nav-secondary-sub-nav-hover-bg-color: #1861D5;

@nav-secondary-sub-nav-hover-text-color: #FFFFFF;

@nav-secondary-item-selected-bg-color: #1861D5;

@nav-secondary-item-selected-text-color: #FFFFFF;

@nav-secondary-item-selected-text-style: bold;

@nav-secondary-item-selected-active-color: #1861D5;

@nav-secondary-sub-nav-selected-bg-color: #1861D5;

@nav-secondary-sub-nav-selected-text-color: #FFFFFF;

@nav-secondary-sub-nav-active-color: #3080FE;

@nav-secondary-item-opened-bg-color: #1861D5;
...
@nav-normal-item-hover-text-color: #3080FE;

@nav-normal-sub-nav-hover-bg-color: #F2F3F7;

@nav-normal-sub-nav-hover-text-color: #3080FE;

@nav-normal-item-selected-bg-color: #F2F3F7;

@nav-normal-item-selected-text-color: #3080FE;

@nav-normal-item-selected-text-style: bold;

@nav-normal-item-selected-active-color: #3080FE;

@nav-normal-sub-nav-selected-bg-color: #F2F3F7;

@nav-normal-sub-nav-selected-text-color: #3080FE;

@nav-normal-sub-nav-active-color: #3080FE;

@nav-normal-item-opened-bg-color: #F2F3F7;

@nav-normal-item-opened-text-color: #3080FE;
...
@nav-line-item-hover-text-color: #3080FE;

@nav-line-sub-nav-hover-bg-color: transparent;

@nav-line-sub-nav-hover-text-color: #3080FE;

@nav-line-item-selected-bg-color: transparent;

@nav-line-item-selected-text-color: #3080FE;

@nav-line-item-selected-text-style: bold;

@nav-line-item-selected-active-color: #3080FE;

@nav-line-sub-nav-selected-bg-color: transparent;

@nav-line-sub-nav-selected-text-color: #3080FE;

@nav-line-sub-nav-active-color: #3080FE;

@nav-line-item-opened-bg-color: transparent;

@nav-line-item-opened-text-color: #3080FE;
...
@tab-close-icon-color-selected: #3080FE;
...
@tab-pure-text-color-selected: #3080FE;

@tab-pure-text-color-disabled: #DCDEE3;

@tab-pure-ink-bar-color: #3080FE;
...
@tab-wrapped-ink-bar-color: #3080FE;

@tab-wrapped-nav-item-border-color-active: #3080FE;
...
@tab-wrapped-text-color-selected: #3080FE;

@tab-wrapped-text-color-disabled: #E0E0E0;
...
@tab-capsule-text-color-disabled: #E0E0E0;

@tab-capsule-bg-color: #F2F3F7;

@tab-capsule-bg-color-hover: #EBECF0;

@tab-capsule-bg-color-selected: #3080FE;

@tab-capsule-bg-color-disabled: #F7F8FA;

@tab-capsule-tab-border-line-color: #C4C6CF;

@tab-capsule-tab-border-line-color-hover: #3080FE;

@tab-capsule-tab-border-line-color-active: #3080FE;
...
@tab-text-text-color-selected: #3080FE;

@tab-text-text-color-disabled: #E0E0E0;
...
@calendar-fullscreen-table-cell-hover-background: #E2EDFF;

@calendar-fullscreen-table-cell-hover-color: #3080FE;

@calendar-fullscreen-table-cell-hover-border-color: #3080FE;

@calendar-fullscreen-table-cell-select-background: #E2EDFF;

@calendar-fullscreen-table-cell-select-color: #3080FE;

@calendar-fullscreen-table-cell-select-border-color: #3080FE;

@calendar-fullscreen-table-cell-select-font-weight: bold;

@calendar-fullscreen-table-cell-current-background: #FFFFFF;

@calendar-fullscreen-table-cell-current-color: #3080FE;

@calendar-fullscreen-table-cell-current-border-color: #3080FE;

@calendar-fullscreen-table-cell-current-font-weight: bold;

@calendar-fullscreen-table-cell-other-background: transparent;

@calendar-fullscreen-table-cell-other-color: #E0E0E0;

@calendar-fullscreen-table-cell-other-border-color: transparent;

@calendar-fullscreen-table-cell-disabled-background: #F7F8FA;

@calendar-fullscreen-table-cell-disabled-color: #E0E0E0;
...
@calendar-card-table-cell-hover-background: #E2EDFF;

@calendar-card-table-cell-hover-color: #3080FE;

@calendar-card-table-cell-hover-border-color: #E2EDFF;

@calendar-card-table-cell-select-background: #3080FE;

@calendar-card-table-cell-select-color: #FFFFFF;

@calendar-card-table-cell-select-border-color: #3080FE;

@calendar-card-table-cell-select-font-weight: bold;

@calendar-card-table-cell-other-background: #FFFFFF;

@calendar-card-table-cell-other-color: #E0E0E0;

@calendar-card-table-cell-other-border-color: #FFFFFF;

@calendar-card-table-cell-disabled-background: #F7F8FA;

@calendar-card-table-cell-disabled-color: #E0E0E0;

@calendar-card-table-cell-disabled-border-color: #F7F8FA;

@calendar-card-table-cell-current-background: #FFFFFF;

@calendar-card-table-cell-current-color: #3080FE;

@calendar-card-table-cell-current-border-color: transparent;

@calendar-card-table-cell-current-font-weight: bold;

@calendar-card-table-cell-inrange-background: #E2EDFF;

@calendar-card-table-cell-inrange-color: #3080FE;

@calendar-card-table-cell-inrange-border-color: #E2EDFF;
...
@calendar-panel-header-background: #3080FE;
...
@breadcrumb-text-keyword-color: #3080FE;

@breadcrumb-icon-color: #A0A2AD;

@breadcrumb-text-color-hover: #3080FE;

@breadcrumb-text-current-color-hover: #3080FE;

@breadcrumb-text-keyword-color-hover: #3080FE;
