...
function getBestMatchSize(width, height) {
  ...
  var matches = aliCDNCropSuffix.filter(function (item) {
    ...
    var itemHeight = parseInt(splited[1], 10); // for retina
...
var _default = function _default(_ref) {
  var width = _ref.width,
      ...
      quality = _ref$quality === void 0 ? 90 : _ref$quality;
  width = parseFloat(width);
  height = parseFloat(height); // prevent string value cause error
  ...
  return suffix ? "_".concat(suffix, "q").concat(quality, ".jpg") : '';
};
